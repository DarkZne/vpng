...
const String endpoint = "https://vpn.groupy.su"; //<= Replace with yours

const String appname = "VPN GROUPY";

const String defaultVpnUsername = "DarkZnec";
const String defaultVpnPassword = "2001DarkZnec!";
